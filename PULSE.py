...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=1R7OF2VAcu4MVPa-wbDr5UIL1uIHAeg8i", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/uc?id=1PjKP8Y8mRKXwepUoFZlKh4YtoUXVGGRB", cache_dir=cache_dir, verbose=verbose) as f:
